...
static weight_t align hidden1_weights[32 * 512];
static weight_t align hidden2_weights[32 * 32];
#else
static weight_t hidden1_weights alignas(64) [64 * 512];
static weight_t hidden2_weights alignas(64) [64 * 32];
#endif
static weight_t align output_weights  [1 * 32];

static int32_t align hidden1_biases  [32];
static int32_t align hidden2_biases  [32];
static int32_t align output_biases[1];
...
static int16_t align ft_biases  [kHalfDimensions];
static int16_t align ft_weights [kHalfDimensions * FtInDims];
