#ifndef TIKI_PERF_TESTS_H
#define TIKI_PERF_TESTS_H


/**
 * Perft data is used to hold test data and expected perft results.
 * Holds up to 6 ply deep, one or two positions are only calculated to 5;
...
static perft_data_t perft_data[] = {
        ...
        { "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1", {48,2039,97862,4085603,193690690, -1}},
